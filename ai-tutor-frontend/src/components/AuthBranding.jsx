import { AUTH_BRANDING_TEXTS, AUTH_TEXTS } from "@/constants/texts";
...
export default function AuthBranding() {
  return (
    <div className="hidden lg:flex lg:w-1/2 flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[hsl(222_26%_8%)] p-12 text-white relative">
      <div
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(135deg,hsl(166_61%_35%/0.36),transparent_38%,hsl(218_82%_45%/0.34))]" />
